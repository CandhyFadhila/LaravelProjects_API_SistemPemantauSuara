...
class StoreAktivitasPelaksanaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'kelurahan_id' => 'required|integer|unique:kelurahans,id',
            'rw' => 'required|integer',
            'pelaksana_id' => 'required|integer|unique:users,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'kelurahan_id.unique' => 'Kelurahan tersebut tidak ada dalam database.',
            ...
            'pelaksana_id.unique' => 'Nama pelaksana tersebut tidak ada dalam database.',
